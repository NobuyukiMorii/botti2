...
<form action="/gachakoi/users/add" enctype="multipart/form-data" role="form" id="UserAddForm" method="post" accept-charset="utf-8">
      ...
      <fieldset>
            ...
            <input name="data[User][nickname]" class="form-control" maxlength="45" type="text" id="UserNickname"/>
            </div>
            </div>
            ...
            <select class="span2" name="data[User][birthday][year]" class="form-control" id="UserBirthdayYear">
                  <?php for($year=date("Y",strtotime("-40 year")); $year<=date("Y",strtotime("-20 year")); $year++) {
                        print('<option value="'.$year.'">'.$year.'</option>');
                  } ?>
            </select>

            <select class="span2" name="data[User][birthday][month]" class="form-control" id="UserBirthdayMonth">
                  <?php 
            ...
            <select class="span2" name="data[User][birthday][day]" class="form-control" id="UserBirthdayDay">
                  <?php 
            ...
            <select class="span2" name="data[User][kibouzikan][hour]" class="form-control" id="UserKibouzikanHour">
                  <?php 
            ...
            <select class="span2" name="data[User][kibouzikan][min]" class="form-control" id="UserKibouzikanMin">
