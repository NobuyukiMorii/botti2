...
<table class="table table-striped table-bordered table-hover">
  ...
  <tr>
    <td><img src="<?php echo $this->Html->url("/webroot/files/image/photo_user/".$bar[$i]['Image'][0]['dir']."/thumb150_".$bar[$i]['Image'][0]['photo_user']);?>" class="img-responsive"></td>
    <td><?php echo h($bar[$i]['User']['last_name']); ?><?php echo h($bar[$i]['User']['first_name']); ?></td>
    <td><?php echo h($bar[$i]['User']['genderText']); ?></td>
